...
export const WorkflowManager = ({ onSelectWorkflow }: WorkflowManagerProps) => {
  ...
  const fetchWorkflows = async () => {
    try {
      ...
      const formattedWorkflows = data?.map(workflow => ({
        id: workflow.id,
        title: (workflow.workflow_data as any)?.title || 'Untitled Data Analysis',
  ...
  const createWorkflow = async () => {
    try {
      ...
      toast({
        title: "Success",
        description: "Data analysis workflow created successfully"
      });
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold">My Data Analysis Workflows</h2>
        ...
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              <DialogTitle>Create New Data Analysis Workflow</DialogTitle>
              <DialogDescription>
                Start tracking a new data analysis project
              </DialogDescription>
            </DialogHeader>
      ...
      {workflows.length === 0 ? (
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <h3 className="text-lg font-semibold mb-2">No Data Analysis Workflows Yet</h3>
            <p className="text-muted-foreground text-center mb-4">
              Create your first data analysis workflow to start tracking your project progress
            </p>
