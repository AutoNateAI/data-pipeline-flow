...
-- Update RLS policies to remove references to dropped columns and tables

-- Drop old policies that reference dropped tables/columns
...
-- Update prompts policies to use created_by instead of user_id
...
-- Update templates policies to use created_by instead of user_id
...
-- Update user_workflows policies (remove workflow_id references)
...
-- Drop indexes that reference dropped columns/tables
