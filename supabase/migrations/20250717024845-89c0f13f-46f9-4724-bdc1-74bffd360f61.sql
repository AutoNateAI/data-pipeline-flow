...
ALTER TABLE public.profiles 
  ...
  ADD COLUMN IF NOT EXISTS total_prompts_copied integer DEFAULT 0,
  ADD COLUMN IF NOT EXISTS total_templates_copied integer DEFAULT 0;

-- Update prompts table
ALTER TABLE public.prompts 
  ADD COLUMN IF NOT EXISTS description text,
  ADD COLUMN IF NOT EXISTS difficulty_level text CHECK (difficulty_level = ANY (ARRAY['Beginner'::text, 'Intermediate'::text, 'Advanced'::text])),
...
-- Make type column NOT NULL after adding it
